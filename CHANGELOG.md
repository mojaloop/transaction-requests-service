...
* dependency security updates and CI config cleanup ([#143](https://github.com/mojaloop/transaction-requests-service/issues/143)) ([515aabd](https://github.com/mojaloop/transaction-requests-service/commit/515aabdf69aa82f7083221b7b3216e65416ddd48))
* **sbom:** update sbom [skip ci] ([5c83193](https://github.com/mojaloop/transaction-requests-service/commit/5c83193a6214e7dd6dafeb613731b09f959e9336))
...
* fix vuls and update deps ([#130](https://github.com/mojaloop/transaction-requests-service/issues/130)) ([52b611c](https://github.com/mojaloop/transaction-requests-service/commit/52b611cc62260240433bb7055df93c90c05bd2f5))
* **sbom:** update sbom [skip ci] ([bba5596](https://github.com/mojaloop/transaction-requests-service/commit/bba55966887b41fc9e8d246072580d60fbb8be3c))
...
* **sbom:** update sbom [skip ci] ([85bd06f](https://github.com/mojaloop/transaction-requests-service/commit/85bd06f7c9657c9f02aba9ba02cb37d1e235b7c7))
* **sbom:** update sbom [skip ci] ([b0792cf](https://github.com/mojaloop/transaction-requests-service/commit/b0792cfd199298109b141344fac0ccd166a192b6))
* update orb version ([#127](https://github.com/mojaloop/transaction-requests-service/issues/127)) ([616e8f6](https://github.com/mojaloop/transaction-requests-service/commit/616e8f63edbd1af56549ad70acf354d7e033d32a))

### [14.4.2](https://github.com/mojaloop/transaction-requests-service/compare/v14.4.1...v14.4.2) (2025-06-19)


### Chore

* update orb version ([#126](https://github.com/mojaloop/transaction-requests-service/issues/126)) ([e841dfe](https://github.com/mojaloop/transaction-requests-service/commit/e841dfe2bcbee9b9295a58b248317ab97449fb20))

### [14.4.1](https://github.com/mojaloop/transaction-requests-service/compare/v14.4.0...v14.4.1) (2025-06-17)


### Chore

* **sbom:** add initial sbom ([#125](https://github.com/mojaloop/transaction-requests-service/issues/125)) ([1c4ced6](https://github.com/mojaloop/transaction-requests-service/commit/1c4ced655ece6cf9f2795f75a4702302260791ba))
* **sbom:** update sbom-v14.4.0.csv [skip ci] ([cafa20d](https://github.com/mojaloop/transaction-requests-service/commit/cafa20d0a753df327e4008fad43b28b307178442))
