...
module.exports = {
  ...
  JWS_VALIDATE: RC.ENDPOINT_SECURITY?.JWS?.JWS_VALIDATE ?? false,
  JWS_VERIFICATION_KEYS_DIRECTORY: RC.ENDPOINT_SECURITY?.JWS?.JWS_VERIFICATION_KEYS_DIRECTORY,
  JWS_VALIDATE_PUT_PARTIES: RC.ENDPOINT_SECURITY?.JWS?.JWS_VALIDATE_PUT_PARTIES ?? false,
